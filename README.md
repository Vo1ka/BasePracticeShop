...
## BasePracticeShop — учебный e‑commerce с акцентом на клиентскую логику <br />
#### Важно! для корректного отображения может понадобиться EU IP
Интерактивный магазин, где основная сложность вынесена на фронтенд: RTK Query, локальное кэширование, оптимизированные селекторы и ролевая модель (user/admin). <br />
**Ключевой функционал**
